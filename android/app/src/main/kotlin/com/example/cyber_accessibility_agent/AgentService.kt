// AgentService.kt - COMPLETE: Flutter on MAIN thread + Plain SharedPreferences
...
class AgentService : Service() {
     ...
     * Only runs once, guarded by plain SharedPreferences
     */
    private fun switchLauncherAliasIfNeeded() {
        ...
        try {
            ...
            // ✅ Mark as switched using plain SharedPreferences
            prefs().edit()
    ...
    override fun onStartCommand(intent: android.content.Intent?, flags: Int, startId: Int): Int {
        ...
        if (flutterEngine == null) {
            ...
            // ✅ CRITICAL FIX: Call Flutter init directly (we're already on main thread in onStartCommand)
            initFlutter()
        } else {
     ...
     * onStartCommand() is ALWAYS called on main thread, so this is safe
     */
