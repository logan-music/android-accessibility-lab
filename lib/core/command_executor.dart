...
import 'device_agent.dart'; // <<-- use DeviceAgent.uploadFile for consistent uploads
...
class CommandExecutor {
  ...
  // Uses DeviceAgent.uploadFile(...) to centralize upload behavior (headers, API key, multipart).
  Future<Map<String, dynamic>> _uploadFileSystem(
    ...
    try {
      ...
      // DeviceAgent.uploadFile SHOULD return Map<String, dynamic> with success key
